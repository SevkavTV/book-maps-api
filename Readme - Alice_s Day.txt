...
The British Library 'Alice Day' dataset is a set of .csv (comma separated value) files containing metadata for resources relating to Alice in Wonderland, from the British National Bibliography (BNB) and our British Library collections. It was initially released to coincide with the 2015 'Alice Day', a celebration of Alice in Wonderland, held annually in July, and has been updated annually thereafter.
